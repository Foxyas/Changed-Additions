...
public class ChangedAdditionsTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<FengQIWolf>> FENG_QI_WOLF = register("form_feng_qi_wolf", TransfurVariant.Builder.of(ChangedAdditionsEntities.FENG_QI_WOLF).breatheMode(TransfurVariant.BreatheMode.NORMAL).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexKitsuneMaleEntity>> LATEX_KITSUNE_MALE = register("form_latex_kitsune/male", () -> TransfurVariant.Builder.of(ChangedAdditionsEntities.LATEX_KITSUNE_MALE).addAbility(ChangedAdditionsAbilities.TELEPORT).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAdditionsAbilities.CLAWS_ABILITY).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexKitsuneFemaleEntity>> LATEX_KITSUNE_FEMALE = register("form_latex_kitsune/female", () -> TransfurVariant.Builder.of(ChangedAdditionsEntities.LATEX_KITSUNE_FEMALE).addAbility(ChangedAdditionsAbilities.TELEPORT).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAdditionsAbilities.CLAWS_ABILITY).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexCalicoCat>> LATEX_CALICO_CAT = register("form_latex_calico_cat", () -> TransfurVariant.Builder.of(ChangedAdditionsEntities.LATEX_CALICO_CAT).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAdditionsAbilities.CLAWS_ABILITY).scares(List.of(Creeper.class)).nightVision());
