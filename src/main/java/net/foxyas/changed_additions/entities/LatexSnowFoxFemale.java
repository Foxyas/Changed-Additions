...
public class LatexSnowFoxFemale extends AbstractLatexSnowFox {
    public LatexSnowFoxFemale(EntityType<? extends ChangedEntity> type, Level level) {
        super(type, level);
    }

    public LatexSnowFoxFemale(PlayMessages.SpawnEntity packet, Level world) {
        this(ChangedAdditionsEntities.LATEX_SNOW_FOX_FEMALE.get(), world);
    }
