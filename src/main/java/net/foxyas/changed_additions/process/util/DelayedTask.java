...
public class DelayedTask {
    ...
    public void pause() {
        this.paused = true;
        ChangedAdditionsMod.LOGGER.info("DelayedTask with ID: " + id + " was paused by an external code");
    }
    ...
    public void resume() {
        this.paused = false;
        ChangedAdditionsMod.LOGGER.info("DelayedTask with ID: " + id + " was resumed by an external code");
    }
