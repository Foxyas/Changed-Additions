...
//            }
        ...
        if (isCreative) {
            ...
            if (Screen.hasShiftDown()) {
                ...
                tooltip.add(index, new TranslatableComponent("text.changed_additions.additionalHealth")
                        .append("")
                        .append(extraHp == 0
                ...
                tooltip.add(index, new TranslatableComponent("text.changed_additions.land_speed")
                        .append("")
                ...
                tooltip.add(index, new TranslatableComponent("text.changed_additions.swim_speed")
                        .append("")
                ...
                tooltip.add(index, new TranslatableComponent("text.changed_additions.jumpStrength")
                        .append("")
                ...
                index++;
                tooltip.add(index, new TranslatableComponent("text.changed_additions.canGlide/Fly")
                        .append("")
            ...
            if (ChangedAdditionsTransfurVariants.isVariantOC(form, entity.getLevel())) {
