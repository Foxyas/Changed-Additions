...
public class LatexSnowFoxMaleModel extends AdvancedHumanoidModel<LatexSnowFoxMale> implements AdvancedHumanoidModelInterface<LatexSnowFoxMale, LatexSnowFoxMaleModel> {
    ...
    private final HumanoidAnimator<LatexSnowFoxMale, LatexSnowFoxMaleModel> animator;

    public LatexSnowFoxMaleModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(@NotNull LatexSnowFoxMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
