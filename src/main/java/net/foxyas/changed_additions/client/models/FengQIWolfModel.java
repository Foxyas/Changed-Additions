...
public class FengQIWolfModel extends AdvancedHumanoidModel<FengQIWolf> {
    ...
    public void prepareMobModel(@NotNull FengQIWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
