...
@Deprecated
public class NeofuserRecipeRecipeCategory implements IRecipeCategory<NeofuserRecipeRecipe> {
	...
	public NeofuserRecipeRecipeCategory(IGuiHelper helper) {
	...
	@Override
	public mezz.jei.api.recipe.RecipeType<NeofuserRecipeRecipe> getRecipeType() {
	...
	@Deprecated
	@Override
	public Class<? extends NeofuserRecipeRecipe> getRecipeClass() {
		return NeofuserRecipeRecipe.class;
	}
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, NeofuserRecipeRecipe recipe, IFocusGroup focuses) {
