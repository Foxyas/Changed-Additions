...
import net.foxyas.changed_additions.mobEffects.SolventEffect;
...
public class ChangedAdditionsMobEffects {
    ...
    public static final RegistryObject<MobEffect> SOLVENT = REGISTRY.register("latex_solvent", SolventEffect::new);
}